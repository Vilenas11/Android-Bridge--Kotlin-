...
var input: String = ""
    while(input != "exit"){
        ...
        if(input == "0") println(camel)
        else if(input == "1") println(lion)
        else if(input == "2") println(deer)
        else if(input == "3") println(goose)
        else if(input == "4") println(bat)
        else if(input == "5") println(rabbit)
    }
